...
import type { Task, TaskEvent, TaskStatus, TaskRecallResult, TaskListQuery, TaskListResponse } from "./types";
...
export class TaskRecordKeeper {
  ...
  async getTask(taskId: string): Promise<Task | null> {
    ...
    const task: Task = {
      ...
      runtimeMs: data.runtimeMs ? Number(data.runtimeMs) : undefined,
