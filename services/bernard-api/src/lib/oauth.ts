...
export async function startOAuthLogin(provider: OAuthProvider, req: FastifyRequest<{ Querystring: OAuthStartQuery }>, reply: FastifyReply) {
  try {
...
export async function handleOAuthCallback(provider: OAuthProvider, req: FastifyRequest<{ Querystring: OAuthCallbackQuery }>, reply: FastifyReply) {
