...
import { useRouter, useParams } from '@/lib/router/compat'
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-start justify-between mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        <span className={`px-3 py-1 rounded text-sm font-medium ${status.status === 'running' ? 'bg-green-900/50 text-green-400' :
                        ...
                        <span className={`px-3 py-1 rounded text-sm font-medium ${status.health === 'healthy' ? 'bg-green-900/50 text-green-400' :
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    <div className="bg-gray-800 rounded-lg p-6">
                        ...
                        <div className="flex items-center gap-3">
                            <div className={`w-4 h-4 rounded-full ${statusColors[status.status]} ${status.status === 'running' ? 'animate-pulse' : ''
                                }`} />
                    ...
                    <div className="bg-gray-800 rounded-lg p-6">
                        ...
                        <span className={`text-white font-medium capitalize ${status.health === 'healthy' ? 'text-green-400' :
